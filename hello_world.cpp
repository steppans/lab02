#include <iostream>
#include <string> // for work with string objects - для работы со строковыми переменными
...
int main(){
    ...
    std::cout << "Hello World from " << name << std::endl; // output interactive string - вывод интерактивной строки 
    return 1;
}
